...
<main>
  <section>
    <?php if ( ! empty( $hero ) ) : ?>
      ...
      <div class="relative z-10 w-11/12 mx-auto flex flex-col md:flex-row-reverse items-center py-8 md:py-12 lg:py-24">
    ...
    <?php if ( ! empty( $selling_points ) ) : ?>
      <div class="w-11/12 mx-auto mt-8 md:mt-16 lg:mt-24">
  ...
  <?php if ( ! empty( $testimonials ) ) : ?>
    <section class="bg-pattern py-32">
      <h3 class="uppercase text-cyan md:text-lg"><?php echo $testimonials['subheading']; ?></h3>
      <h2><?php echo $testimonials['heading']; ?></h2>
      <div class="testimonial-list flex flex-col md:flex-row -mx-8">
      <?php foreach ( $testimonials['quotes'] as $testimonial ) : ?>
        <blockquote class="testimonial rounded bg-white p-8 shadow-md">
          <div class="flex">
            <svg class="text-cyan" width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
