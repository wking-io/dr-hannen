...
<form role="search" method="get" class="search-form flex items-center relative z-50" action="<?php echo home_url( '/' ); ?>">
    ...
    <label class="relative block">
        ...
        <input type="search" class="text-sm flex items-center bg-grey-100 text-grey-800 py-1 px-2 pl-8 rounded w-56" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder' ) ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label' ) ?>" />
    </label>
