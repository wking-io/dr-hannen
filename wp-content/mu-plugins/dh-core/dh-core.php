...
class DhCore {
    ...
    public function register_public_styles() {
      ...
      wp_register_style('dh_home', $this->get_asset_url( 'css/home.css' ), array(), '1.0.1' );
      ...
      wp_register_style('dh_shop', $this->get_asset_url( 'css/shop.css' ), array(), '1.1.1' );
      wp_register_style('dh_product', $this->get_asset_url( 'css/product.css' ), array(), '1.2.3' );
      wp_register_style('dh_cart', $this->get_asset_url( 'css/cart.css' ), array(), '1.2.0' );
      ...
      wp_register_style('dh_teladoc', $this->get_asset_url( 'css/teladoc.css' ), array(), '1.0.0' );
    }
    ...
    public function register_public_scripts() {
      ...
      wp_register_script('dh_home', $this->get_asset_url( 'js/home.js' ), array(), '1.0.1', true );
